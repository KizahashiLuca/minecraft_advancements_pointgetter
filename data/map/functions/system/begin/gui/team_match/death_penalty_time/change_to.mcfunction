...
## Set scoreboard
scoreboard players operation #map Digit0100 = #map DeathPenaltyTime
scoreboard players operation #map Digit0100 /= #map 100
scoreboard players operation #map Digit0010 = #map DeathPenaltyTime
scoreboard players operation #map Digit0010 %= #map 100
scoreboard players operation #map Digit0010 /= #map 10
scoreboard players operation #map Digit0001 = #map DeathPenaltyTime
scoreboard players operation #map Digit0001 %= #map 100
scoreboard players operation #map Digit0001 %= #map 10

## Replace inventory
loot replace entity @p[predicate=map:player/host] inventory.4 loot map:system/begin/gui/team_match/death_penalty_time
...
loot replace entity @p[predicate=map:player/host,predicate=map:system/begin/gui/team_match/death_penalty_time/gt_zero] inventory.25 loot map:system/begin/gui/team_match/death_penalty_time/ok

## Change phase
scoreboard players set #map Phase 12
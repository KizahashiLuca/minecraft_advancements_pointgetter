...
## Set scoreboard
scoreboard players operation #map Digit0100 = #map CartInterval
scoreboard players operation #map Digit0100 /= #map 100
scoreboard players operation #map Digit0010 = #map CartInterval
scoreboard players operation #map Digit0010 %= #map 100
scoreboard players operation #map Digit0010 /= #map 10
scoreboard players operation #map Digit0001 = #map CartInterval
scoreboard players operation #map Digit0001 %= #map 100
scoreboard players operation #map Digit0001 %= #map 10

## Replace inventory
loot replace entity @p[predicate=map:player/host] inventory.4 loot map:system/begin/gui/root/minecart_interval
...
loot replace entity @p[predicate=map:player/host,predicate=map:system/begin/gui/minecart_interval/gt_zero] inventory.25 loot map:system/begin/gui/minecart_interval/ok

## Change phase
scoreboard players set #map Phase 4